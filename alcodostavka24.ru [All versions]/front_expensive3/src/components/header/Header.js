      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            <div className='header_number'><a className='tel_number' href="tel:5554280940">Круглосуточно: +7 (000) 000-00-01</a><Link onClick={() => window.open("https://t.me/alcodostavkamolnia_bot", '_blank')}><Icon.Telegram className="telegram_icon_header" /></Link> <p style={{color : "white"}}>входящие звонки бесплатно</p></div>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
