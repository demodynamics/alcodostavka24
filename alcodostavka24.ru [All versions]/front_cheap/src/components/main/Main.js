...
function Main() {
    ...
    return (
        <>
            <Icon.Telegram className="telegram_icon"  onClick={() => window.open("https://t.me/alcodostavka24molnia_bot", '_blank')}/>
            <div className='mainFoto'>
                <div className="divText">
                    <p>ДОСТАВКА АЛКОГОЛЯ ПО МОСКВЕ
                        ...
                        <br />
                        <br />
                        <Button className="button_telegram" variant="warning"  onClick={() => window.open("https://t.me/alcodostavka24molnia_bot", '_blank')}>Заказать через телеграм{' '}<Icon.Telegram className="telegram_button_icon" /></Button>
                        <Button className="button_one_click" variant="warning" onClick={handleShow}>Купить в 1 клик</Button>
                    </p>
                </div>
