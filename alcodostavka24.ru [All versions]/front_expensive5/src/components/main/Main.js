            ...
            <div className='mainFoto'>
                <div className="divText">
                    <p>ДОСТАВКА АЛКОГОЛЯ ПО МОСКВЕ
                        ...
                        <br />
                        <br />
                        <Button className="button_telegram" variant="warning" onClick={() => window.open("https://t.me/alcodostavkamolnia_bot", '_blank')}>Заказать через телеграм{' '}<Icon.Telegram className="telegram_button_icon" /></Button>
